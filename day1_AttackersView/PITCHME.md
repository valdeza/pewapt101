...
<!-- SKIPPED: [Slide Image Placeholder 6]-->
...
<!-- SKIPPED: [Slide Number Placeholder 2]-->
...
<!--[TextBox 15]-->
Web page returns with XSS code

<!--[Oval 75]-->
**2**

<!--[TextBox 15]-->
When **onunload  **event fires, the browser launches a pop-up that loads malicious code from the evil web server
...
<!--[TextBox 15]-->
When **onclick  **event fires, the JavaScript changes the location of the anchor to point to the evil web server
...
<!--[TextBox 15]-->
XMLHTTPRequest object sends a POST request to Google to retrieve the search results for the string "Security 542".
...
<!--[TextBox 15]-->
Web page returns containing AJAX code
